...
<h2 class="fw-bold fs-2 fs-lg-5 lh-sm mb-4">가입시 입력한 이메일과 비밀번호를 입력해주세요!</h2>
	<div class="col-lg-7 mx-auto text-center mb-4" style="background-color:#fff;border-radius:2rem;padding:1.5rem;">
		<form action="/delete" method="post" id="form">
			...
			<div class="row">
				<div class="col-md-3 fw-bold fs-5 mt-1 text-center" style="text-align: left">이메일</div>
				<div class="col-md-8 form-group">
				<input class="form-control" type="text" name="user_email" id="user_email" />
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 fw-bold fs-5 mt-1 text-center" style="text-align: left">비밀번호</div>
				<div class="col-md-8 form-group">
				<input class="form-control" type="password" name="user_pw" id = "user_pw"/>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 fw-bold fs-5 mt-1 text-center" style="text-align: left">탈퇴사유</div>
				<div class="col-md-8 form-group">
