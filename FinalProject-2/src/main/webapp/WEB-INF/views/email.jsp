...
<div class="page-heading" style="margin-top:120px;">	 
    <div class="col-lg-7 mx-auto text-center mb-4" style="background-color:#fff;border-radius:3rem;padding:1.5rem;">
        ...
        <form action="/sendCode" method="post">
            <div class="row">
				<div class="col-md-3 fw-bold fs-5 mt-1 text-center " style="text-align: left;">이메일 입력</div>
				<div class="col-md-8 form-group" style="width:75%; text-align:center;">
